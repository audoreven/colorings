...
title = 'Vertex Coloring on K_n,n w/ Max Degree Delta'
subtitle = f'N = {n}, Delta = {d}'
plt.suptitle(title, fontsize=14)
plt.title(subtitle, fontsize=10)
plt.plot(fixed_kds, glauber_mix_times, color='blue', label="glauber dynamics")
plt.plot(fixed_kds, flip_mix_times, color='red', label="flip dynamics")
plt.legend()
